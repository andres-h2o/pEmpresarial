...
function findme(findM){
    document.getElementById("inLat").value = findM.coords.latitude;
    document.getElementById("inLon").value = findM.coords.longitude;
    coords =  {
        lng: findM.coords.longitude,
        lat: findM.coords.latitude
    };
    setMapa(coords);
}
